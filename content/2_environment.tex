...
\begin{assumption}{Sample Assumption}{sample}
  This is an example of an assumption environment.
\end{assumption}

\begin{conjecture}{Sample Conjecture}{sample}
  This is an example of a conjecture environment.
\end{conjecture}

\begin{lemma}{Sample Lemma}{sample}
  Based on \refdef{sample}.
  This is an example of a lemma. 
  It shares the same style as the theorem environment.
\end{lemma}
\begin{proof}
...
\begin{corollary}{Sample Corollary}{sample}
...
\begin{proposition}{Sample Proposition}{sample}
...
\begin{remark}{Sample Remark}{sample}
  This is an example of a remark environment.
\end{remark}

\begin{note}{Sample Note}{sample}
  This is an example of a note environment.
\end{note}

\begin{example}{Sample Example}{sample}
...
\begin{problem}{Sample Problem}{sample}
  This is an example of a problem environment.
\end{problem}

\begin{todo}{Sample ToDo}{sample}
  This is an example of a ToDo environment.
\end{todo}
