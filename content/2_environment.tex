...
\begin{itemize}
    \item \Verb|\refdef{label}| --- Reference to Definition~\ref{def:label}
    \item \Verb|\refasm{label}| --- Reference to Assumption~\ref{asm:label}
    \item \Verb|\refconj{label}| --- Reference to Conjecture~\ref{conj:label}
    \item \Verb|\reflem{label}| --- Reference to Lemma~\ref{lem:label}
    \item \Verb|\refthm{label}| --- Reference to Theorem~\ref{thm:label}
    \item \Verb|\refcor{label}| --- Reference to Corollary~\ref{cor:label}
    \item \Verb|\refprop{label}| --- Reference to Proposition~\ref{prop:label}
    \item \Verb|\refremk{label}| --- Reference to Remark~\ref{remk:label}
    \item \Verb|\refnote{label}| --- Reference to Note~\ref{note:label}
    \item \Verb|\refex{label}| --- Reference to Example~\ref{ex:label}
    \item \Verb|\refprob{label}| --- Reference to Problem~\ref{prob:label}
    \item \Verb|\reftodo{label}| --- Reference to ToDo~\ref{todo:label}
\end{itemize}
