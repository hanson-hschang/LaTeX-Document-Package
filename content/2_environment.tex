...
Custom languages can be added using the \Verb|\newminted| command as shown in the package configuration.
...
SI units with \Verb|siunitx|: \SI{299792458}{\meter\per\second}, \SI{1.602e-19}{\coulomb}, \SI{6.626e-34}{\joule\second}.
...
\begin{itemize}
    \item \Verb|\refdef{label}| --- Reference to Definition (e.g., \texttt{\textbackslash{}ref\{def:label\}})
    \item \Verb|\refasm{label}| --- Reference to Assumption (e.g., \texttt{\textbackslash{}ref\{asm:label\}})
    \item \Verb|\refconj{label}| --- Reference to Conjecture (e.g., \texttt{\textbackslash{}ref\{conj:label\}})
    \item \Verb|\reflem{label}| --- Reference to Lemma (e.g., \texttt{\textbackslash{}ref\{lem:label\}})
    \item \Verb|\refthm{label}| --- Reference to Theorem (e.g., \texttt{\textbackslash{}ref\{thm:label\}})
    \item \Verb|\refcor{label}| --- Reference to Corollary (e.g., \texttt{\textbackslash{}ref\{cor:label\}})
    \item \Verb|\refprop{label}| --- Reference to Proposition (e.g., \texttt{\textbackslash{}ref\{prop:label\}})
    \item \Verb|\refremk{label}| --- Reference to Remark (e.g., \texttt{\textbackslash{}ref\{remk:label\}})
    \item \Verb|\refnote{label}| --- Reference to Note (e.g., \texttt{\textbackslash{}ref\{note:label\}})
    \item \Verb|\refex{label}| --- Reference to Example (e.g., \texttt{\textbackslash{}ref\{ex:label\}})
    \item \Verb|\refprob{label}| --- Reference to Problem (e.g., \texttt{\textbackslash{}ref\{prob:label\}})
    \item \Verb|\reftodo{label}| --- Reference to ToDo (e.g., \texttt{\textbackslash{}ref\{todo:label\}})
\end{itemize}
