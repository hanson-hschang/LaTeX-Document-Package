...
To use this package, one can use \Verb|\usepackage{document}| right after the \Verb|\documentclass{article}| command.
This package also imports the following packages:
\begin{itemize}
  \item  Parsing and conditional: 
\end{itemize}
This package provides the following optional arguments:
\begin{itemize}
    \item \Verb|theorems|
\end{itemize}
