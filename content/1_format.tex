...
\begin{description}
    \item[\texttt{theorems=true/false}] (default: \texttt{true}) Enable or disable theorem-like environments (definition, theorem, lemma, corollary, proof, example, etc.). When \texttt{false}, the \Verb|thmtools| and \Verb|tcolorbox| packages are not loaded, and all theorem-like environments become unavailable.
...
\begin{itemize}
    \item \Verb|\refalg{name}| --- Reference to Algorithm~\texttt{\textbackslash{}ref\{alg:name\}}
    \item \Verb|\reffig{name}| --- Reference to Figure~\texttt{\textbackslash{}ref\{fig:name\}}
    \item \Verb|\reftab{name}| --- Reference to Table~\texttt{\textbackslash{}ref\{tab:name\}}
\end{itemize}
